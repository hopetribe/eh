"""r13固定验证：只评估训练胜出的量能与ATR组合。"""
from __future__ import annotations

import json
from pathlib import Path

from gcn.backtest.signal_research_r13 import candidate_signals, CHALLENGERS, RULES
...
def run_validation(snapshot: Path, training: Path, output: Path) -> dict:
    return _run_validation(snapshot, training, output, research_version="gcn-historical-r13",
                           ...
                           validator_source="gcn/backtest/signal_research_r13_validation.py")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--training", type=Path, default=Path("reports/gcn-historical-r13-20260905/results"))
