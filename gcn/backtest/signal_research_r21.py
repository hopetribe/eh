...
def run_training(snapshot: Path, output: Path) -> dict:
    return _run_training(snapshot, output, research_version="gcn-historical-r21",
                         ...
                         failure_checker=candidate_failures, entry_breakeven_base_col="ENTRY_BE_BASE",
                         extra_sources=("gcn/backtest/signal_research_r17.py",
                                        "gcn/backtest/signal_research_r21.py"))
